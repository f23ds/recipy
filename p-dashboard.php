      ...
      <div class="tab-content" id="content1">
        <div class="recipes-grid" id='resultado'>
          <div class="recipe-dashboard-card">
            <img src="img/recipe.png" alt="Spaghetti">
            <div class="card-info">
              <a href="recipe.php?recipe_id=1" class="card-title">Spaghetti Bolognese</a>
              <span class="card-sub">@laura • 2 servings</span>
            </div>
          </div>

          <div class="recipe-dashboard-card">
            <img src="img/recipe.png" alt="Tiramisu">
            <div class="card-info">
              <a href="recipe.php?recipe_id=2" class="card-title">Tiramisu</a>
              <span class="card-sub">@mario • 4 servings</span>
            </div>
          </div>

          <div class="recipe-dashboard-card">
            <img src="img/recipe.png" alt="Toast">
            <div class="card-info">
              <a href="recipe.php?recipe_id=3" class="card-title">Avocado Toast</a>
              <span class="card-sub">@chef99 • 1 serving</span>
            </div>
          </div>
